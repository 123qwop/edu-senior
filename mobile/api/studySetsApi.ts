...
/** Bearer token (mobile) + optional cookies (web). */
...
export async function getClassStudents(classId: number): Promise<Student[]> {
  try {
    const response = await fetch(
      `${API_URL}/study-sets/classes/${classId}/students`,
      {
        method: "GET",
        credentials: "include",
        headers: await getAuthHeaders(),
...
export async function searchUsers(query: string): Promise<Student[]> {
  try {
    const response = await fetch(
      `${API_URL}/study-sets/users/search?query=${encodeURIComponent(query)}`,
      {
        method: "GET",
        credentials: "include",
        headers: await getAuthHeaders(),
...
export async function removeStudentFromClass(
  ...
  try {
    const response = await fetch(
      `${API_URL}/study-sets/classes/${classId}/students/${studentId}`,
      {
        method: "DELETE",
        credentials: "include",
        headers: await getAuthHeaders(),
...
export async function createAssignment(
  ...
  try {
    const response = await fetch(
      `${API_URL}/study-sets/classes/${classId}/assignments`,
      {
        method: "POST",
        credentials: "include",
        headers: await getAuthHeaders(),
...
export async function getClassStudentsProgress(
  ...
  try {
    const response = await fetch(
      `${API_URL}/study-sets/classes/${classId}/students/progress`,
      {
        method: "GET",
        credentials: "include",
        headers: await getAuthHeaders(),
...
export async function markStudySetOffline(setId: number): Promise<void> {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.detail || "Failed to mark study set as offline",
      );
    }
  } catch (err) {
    if (err instanceof TypeError && err.message === "Failed to fetch") {
...
export async function removeStudySetOffline(setId: number): Promise<void> {
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.detail || "Failed to remove study set from offline",
      );
    }
  } catch (err) {
    if (err instanceof TypeError && err.message === "Failed to fetch") {
...
export async function getDashboardAssignments(): Promise<
  DashboardAssignment[]
> {
  try {
    const response = await fetch(
      `${API_URL}/study-sets/dashboard/assignments`,
      {
        credentials: "include",
        headers: await getAuthHeaders(),
      },
...
export async function getRecommendations(): Promise<Recommendation[]> {
  try {
    const response = await fetch(
      `${API_URL}/study-sets/dashboard/recommendations`,
      {
        credentials: "include",
        headers: await getAuthHeaders(),
      },
...
export async function getNextRecommendation(): Promise<NextRecommendation> {
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json().catch(() => ({}));
      throw new Error(
        errorData.detail || "Failed to fetch next recommendation",
      );
    }
...
export async function updateQuestion(
  ...
  try {
    const response = await fetch(
      `${API_URL}/study-sets/${setId}/questions/${questionId}`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
